...
const updateClient = (index, client) => {
    const dbClient = readClient();
    client.tipoRecitativoName = getCategoryNameById(client.tipoRecitativo); // Adiciona o nome da categoria
...
const saveClient = () => {
    if (isValidFields()) {
        const client = {
            ...
            tipoRecitativo: document.getElementById('tipoRecitativo').value,
        };

        console.log(client); // Adicione esse log
...
const createRow = (client, index) => {
    ...
    newRow.innerHTML = `
        ...
        <td>${client.data}</td>
        <td>${client.tipoRecitativo}</td> <!-- Adicione essa linha -->
        <td>
