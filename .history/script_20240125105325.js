...
const getLastUpdate = () => localStorage.getItem('lastUpdate') || 0;

const setLastUpdate = () => localStorage.setItem('lastUpdate', Date.now());
...
const updateCounterIfNeeded = () => {
    if (shouldUpdateCounter()) {
        contadorRegistros = getLocalStorage().length;
        updateCounter();
        setLastUpdate();
    }
};
